...
try:
    ...
    # --- 3. RUÈNO TRENIRANJE I ISPIS ZA MLP (AKO ŽELIŠ POSEBAN ISPIS) ---
    ...
    # PAŽNJA: Provjeri da li su ti varijable za CatBoost (actr1, acte1...) definisane iznad
    ...
    # --- 3. PRIKAZ I SPAŠAVANJE ---
    plt.tight_layout() # Automatski popravlja razmak izmeðu grafikona
    plt.savefig("Rezultati_Grafikon.png", dpi=300) # Spašava sliku u visokoj rezoluciji
    plt.show()
